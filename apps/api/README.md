...
HTTP telemetry uses the privacy-safe `@vocabulary/observability` boundary. Provider adapters are
disabled locally, and request content is never accepted as a telemetry field. Operational response
procedures are documented in `docs/OBSERVABILITY.md`.
