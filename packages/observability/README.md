...
Vocabulary generation metrics use fixed stage and outcome enums plus bounded counts. They never
accept topics, generated terms, definitions, examples, or provider payloads.
